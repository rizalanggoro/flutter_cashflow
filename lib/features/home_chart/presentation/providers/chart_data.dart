import 'package:cashflow/features/home_chart/domain/entities/chart_data_item.dart';
import 'package:cashflow/features/home_chart/presentation/providers/selected_date_range.dart';
...
import 'package:cashflow/shared/data/providers/isar.dart';
...
import 'package:cashflow/shared/presentation/providers/selected_date_range_filter.dart';
...
class ChartDataNotifier extends AsyncNotifier<List<ChartDataItem>> {
  ...
  Future<List<ChartDataItem>> build() async {
    ...
    if (walletId != null) {
      ...
      final firstDate = ref.watch(firstSelectedDateRangeProvider);
